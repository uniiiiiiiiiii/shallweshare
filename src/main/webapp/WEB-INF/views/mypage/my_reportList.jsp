	...
	<table width="700" border="1">
		...
		<c:forEach items="${myReportList}" var="myReportList" varStatus="i">
			<tr>
				...
				<td><a href="../report/report_view?report_id=${myReportList.report_id}" onclick="window.open(this.href, '_blank', 'width=620, height=950'); return false;">${myReportList.report_title}</a></td>
